...
**Is the Illinois power grid prepared for projected data center growth**? To attempt to answer this question, we look at historical electrical generation data, forecasts from managing operators, and the existing mix of power generation options.

Most public sources for Illinois data center power usage are indirect, using reports, projections, and aggregate sector data. New legislation (SB2181, effective 2026) will soon require annual public reporting of site-level data center energy use for all operators in Illinois.

While there is much uncertainty (and this is certainly not limited to energy needs), we can make three observations:

1. Past electrical generation in Northern Illinois COMED zone shows a steady, modest rise
2. COMED forecasts for 2025 and beyond are relatively flat and do not anticipate an "AI bump"
3. Illinois would likely boost nuclear and increase reliance on the PJM grid while ramping up renewables

## Business Problem

[_Explain context, business relevance, and motivation[11][7]._]

### Is the Illinois power grid prepared for projected data center growth in 2026 and beyond?

Illinois has the 6th highest number of data centers in the US, with 154 as of Q3 2025. Most are concentrated near Chicago.

AI/ML workloads, power/grid constraints, sustainability initiatives, and distributed edge-compute are driving the next wave of massive data center investment and expansion for 2026 and beyond. This

PJM is a regional transmission operator that keeps the power grid running smoothly across several eastern US states, including the COMED (Commonwealth Edison) zone in Northern Illinois. PJM doesn’t make electricity; it manages who supplies power, keeps prices stable and prevents outages. Think of PJM as an "air traffic controller" of energy distribution.

Most forward-looking analyses on this topic reflect the uncertainty and provide low, medium and high scenarios. An 8% increase in costs to the consumer is a common talking point.
...
[_Folder/file overview for repo navigation[7]._]
